                    ...
                    <div className="bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            ...
                            <div className="mb-6 flex items-center justify-between">
                              ...
                              routeName="staff_packages.index"
                              placeholder="Seacrh Packages..."
                              />

                                <div className="flex gap-4 items-center">
                                <Can permission='delete-package'>
                                    <Link href={route("staff_packages.trash")}>
                                <FaRecycle className="text-xl " />
                                </Link>
                                </Can>
                                <Can permission='create-package'>
                                    <Link href={route("staff_packages.create")}>
                                    <PrimaryButton>
                                        + Create Package
                                    </PrimaryButton>
                                </Link>
