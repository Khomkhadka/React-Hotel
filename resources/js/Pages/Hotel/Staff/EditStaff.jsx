...
export default function EditStaff({ staff,roles }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route("hotel_staffs.update", staff.id));
    };
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gray-100">
                <div className="w-full rounded-lg bg-white p-8 shadow-lg border border-slate-200">
...
/* Layout */
EditStaff.layout = (page) => (
    <AuthenticatedHotelLayout header="Edit Staff">
        {page}
